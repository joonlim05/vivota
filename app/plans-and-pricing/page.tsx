...
export default function PlansPricing() {
    return (
        <div className="max-w-7xl mx-auto my-16 md:my-24 lg:my-32">
            <h1 className="text-xl md:text-4xl text-center font-bold mb-8">Our Vivota Plans</h1>
            <h2 className="text-lg text-white text-center mb-32">Affordable, Comprehensive, Effective.</h2>

            <div className="flex flex-col md:flex-row justify-center gap-12 mb-32">
                ...
                <div className="card w-96 bg-base-100 shadow-sm flex flex-col">
                    <div className="card-body flex flex-col h-full">
                        ...
                        <ul className="mt-6 flex flex-col gap-2 text-sm">
                            ...
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                <span>Team Based Collaborative Learning</span>
                            </li>
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>

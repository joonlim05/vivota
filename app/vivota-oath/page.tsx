...
export default function VivotaOath() {
    return (
        <div className="max-w-7xl mx-auto my-16 md:my-24 lg:my-32">
            <h1 className="text-xl md:text-4xl text-center font-bold mb-12">The Vivota Oath</h1>
            <h2 className="text-lg text-white text-center mb-32">Our promise to every student, parent and member of the Vivota Family</h2>

            <section className="py-16 px-6 md:px-24">
                {/* 1. Student First */}
                <div className="flex flex-col md:flex-row items-start mb-32 gap-12">
                    ...
                    <div className="md:w-1/2 flex justify-center items-center">
                        ...
                        <img src="icons/wellbeing.png" alt="Wellbeing Icon" className="w-48 h-48" />
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-start mb-32 gap-12">
                    <div className="md:w-1/2 flex justify-center items-center">
                        <img src="icons/blueprint.png" alt="Blueprint Icon" className="w-48 h-48" />
                    </div>
                    <div className="md:w-1/2">
                        ...
                        <p className="text-gray-700 font-semibold">No extra fluff, just simply a proven formula.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-start mb-32 gap-12">
                    ...
                    <div className="md:w-1/2 flex justify-center items-center">
                        <img src="icons/discussion.png" alt="Team-Based Learning Icon" className="w-48 h-48" />
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-start mb-32 gap-12">
                    <div className="md:w-1/2 flex justify-center items-center">
                        <img src="icons/parents.png" alt="Parents Icon" className="w-48 h-48" />
                    </div>
                    <div className="md:w-1/2">

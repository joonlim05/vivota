const vivotaOathSections = [
    {
        ...
        list: [
            "Guaranteed quick replies 24/7",
            "Weekly check-ins with each student to adjust workload and stress levels",
            "Extra 1-to-1 consult slots during crunch periods for targeted help",
            "Monthly Mastery Action Plan – a snapshot of content mastery, habits, wellbeing, and a clear action plan for improvement.",
        ],
    ...
    },
    {
        ...
        extraText: "No extra fluff, just a structured system that benefits every student.",
        imgSrc: "/gears.svg",

...
export default function SchedulePage() {
    const schedule = [
        { day: 'Monday', time: '5:00 - 7:00 pm', subject_short: 'J1 Bio', subject_long: 'J1 Biology', tutor: 'Kaiser' },
        ...
        { day: 'Thursday', time: '5:00 - 7:00 pm', subject_short: 'J2 Chem', subject_long: 'J2 Chemistry', tutor: 'Elijah' },
        { day: 'Thursday', time: '7:00 - 9:00 pm', subject_short: 'J1 GP', subject_long: 'J1 General Paper', tutor: 'Tenor' },
        ...
        { day: 'Saturday', time: '8:30 - 10:30 am', subject_short: 'Free Slot', subject_long: 'Free Slot', tutor: '' },
        { day: 'Saturday', time: '3:30 - 5:30 pm', subject_short: 'J2 Chem', subject_long: 'J2 Chemistry', tutor: 'Elijah' },

...
export default function SchedulePage() {
    const schedule = [
        ...
        { day: 'Tuesday', time: '5:00 - 7:00 pm', subject_short: 'J2 GP', subject_long: 'J2 General Paper', tutor: 'Fellah', outlet: 'Beauty World' },
        ...
        { day: 'Sunday', time: '3:00 - 5:00 pm', subject_short: 'J1 GP', subject_long: 'J1 General Paper', tutor: 'Fellah', outlet: 'Beauty World' },

...
export default function MissionStatement() {
    return (
        <div className="max-w-7xl min-h-screen mx-auto flex flex-col items-center">
            ...
            <p className="text-base md:text-lg my-8 leading-loose tracking-wide">
                ...
                By relying on our unique and proprietary Vivota System we alleviate
            ...
            <p className="max-w-3xl text-center text-base md:text-lg my-8 leading-loose tracking-wide">Our vision is for Vivota to be an exciting place where students can feel alive, even while they grind for the A Levels, and never forget that
